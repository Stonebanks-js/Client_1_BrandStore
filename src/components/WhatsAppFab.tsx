...
export default function WhatsAppFab() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 right-5 z-[70] flex items-center gap-3 rounded-full border border-gold/45 bg-ink-2/92 py-3 pl-3.5 text-gold shadow-[0_18px_48px_-18px_rgba(0,0,0,0.9)] backdrop-blur-md transition-[transform,opacity,padding] duration-[520ms] ease-[cubic-bezier(0.16,1,0.3,1)] hover:border-gold hover:text-gold-lt sm:bottom-8 sm:right-8 ${
